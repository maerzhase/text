...
public class Hashtable extends java.util.Dictionary implements Cloneable
{
	...
	/**
	 * Removes the object with the specified key from the table. Returns the object removed or null if there was no such
	 * object in the table.
	 */
...
/*
 * $Log: Hashtable.java,v $ /* Revision 1.2 2003/08/17 21:55:24 dvd /* Hyphenator.java is a java program /* Revision 1.1
