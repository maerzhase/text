...
public interface ErrorHandler
{
	 ...
	 * 
	 * @param guard
	 *            a string used to display debugging information selectively
	 * @param s
	...
	public static class NotSetException extends RuntimeException
	{
		...
		public NotSetException(Exception e)
		{
			super(e.toString());
		}


		public NotSetException(String s)
		{
			super(s);
		}
	...
	public static final ErrorHandler	DEFAULT	= new ErrorHandler() {
													...
													public boolean isDebugged(String guard)
													{
														throw new NotSetException(guard);
													}
												};
}

/*
 * $Log: ErrorHandler.java,v $ Revision 1.2 2003/08/20 16:12:32 dvd java docs
 * 
 * Revision 1.1 2003/08/17 21:55:24 dvd Hyphenator.java is a java program
 */
