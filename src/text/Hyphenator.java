...
public class Hyphenator
{
	...
	/**
	 * creates an uninitialized instance of Hyphenator. The same instance can be reused for different hyphenation
	 * tables.
	 */
	public Hyphenator()
	{
				...
				try {
					...
					switch (cc) {
						case '^': {
							...
							break;
						/*
						 * many hyphenation patterns contain accents patterned after \rm font's macros the simplest
						 * approach is to adopt it -- and when I look at this code I am really not sure whether it does
						...
						case '\\': {
							...
							switch (cc1) {
								...
								case 's': { // special characters
									...
									int sep = -1; // separator: nothing, space, curly bracket, backslash for dotless i
													// and j
									int cc0 = in.read(); // base character
									if ((cc0 == ' ' && !(cc1 == 'l' || cc1 == 'o' || cc1 == 'i')) // \c o, but not \l ,
																									// \o , \i ,
											|| cc0 == '{' || cc0 == '\\') {
										sep = cc0;
										cc0 = in.read();
									...
									cc = chrval != null ? ((Integer) chrval).intValue() : cc0; // unless the code for
																								// the accented
																								// character is known,
																								// use unmodified one
								}
	...
	void readException(Scanner s)
	{
		...
		for (;;) {
			if (in == i0)
				return;
			else if (s.pattern[i0] == '-')
				++i0;
			else if (s.pattern[in - 1] == '-')
				--in;
			else
				break;
		}
...
/*
 * $Log: Hyphenator.java,v $ Revision 1.17 2003/08/25 08:41:28 dvd 1. Added symbolic accents: dot above, ring, ogonek,
 * \i. 2. Updated hyphenation tables for German, two tables are provided, with hexadecimal values and symbolic accents.
 * 
 * Revision 1.16 2003/08/21 16:03:52 dvd atilde added
 * 
 * Revision 1.15 2003/08/21 08:52:59 dvd pre-release 1.0
 * 
 * Revision 1.14 2003/08/21 05:50:30 dvd *** empty log message ***
 * 
 * Revision 1.13 2003/08/20 22:40:24 dvd bug fixes
 * 
 * Revision 1.12 2003/08/20 22:34:38 dvd bug fixes
 * 
 * Revision 1.11 2003/08/20 22:18:01 dvd *** empty log message ***
 * 
 * Revision 1.10 2003/08/20 20:34:46 dvd complete acctab
 * 
 * Revision 1.9 2003/08/20 18:55:36 dvd Makefile makes
 * 
 * Revision 1.8 2003/08/20 18:07:07 dvd main() added to Hyphenator as invocation example
 * 
 * Revision 1.7 2003/08/20 17:31:55 dvd polish l and scandinavian o (accented) are fixed
 * 
 * Revision 1.6 2003/08/20 16:12:32 dvd java docs
 * 
 * Revision 1.5 2003/08/17 22:06:12 dvd *** empty log message ***
 * 
 * Revision 1.4 2003/08/17 21:55:24 dvd Hyphenator.java is a java program
 * 
 * Revision 1.3 2003/08/17 20:30:43 dvd CVS keywords added
 */
