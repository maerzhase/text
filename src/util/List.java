...
/**
 * Lispish list. Not very lispish, but still... The compromise is that some of operations are destructive.
 */
...
public class List implements Cloneable
{
	 ...
	 * 
	 * @param t
	 *            list to put the new values into
	 * @param a
	 *            applicator
	...
	/**
	 * cut the list after the mark, the length value will be incorrect if elements are inserted before the mark
	 */
...
/*
 * $Log: List.java,v $ /* Revision 1.2 2003/08/17 21:55:24 dvd /* Hyphenator.java is a java program /* Revision 1.1
 * 2003/08/17 20:31:00 dvd CVS keywords added
 */
